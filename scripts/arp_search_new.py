...
transfer_input_files = {program}, {uai_loc}, {vo_loc}
arguments = {time_limit_shell} {memory_limit_kb} ./ARP-v3.0.2 -nR 2000000000 -igEH 0 -a context -fUAI {uai_file} -fVO {vo_file} {option_strings_cmd} -t {time_limit} -exactZ {Z_value}
queue
...
run(solver_name='EXP_AO_0_N', time_limit=3600)